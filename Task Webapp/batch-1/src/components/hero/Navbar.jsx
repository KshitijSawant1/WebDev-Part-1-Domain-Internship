...
const Navbar = () => {
  ...
  return (
    <nav
      className="fixed top-0 z-20 w-full bg-white border-b border-gray-200 
    ...
    >
      <div className="max-h-screen-xl mx-auto flex flex-wrap items-center justify-between p-4">
        ...
        <div className="flex items-center space-x-4 md:order-2">
          <Link
            to="/playground"
            className="px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg 
        hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 
        dark:hover:bg-blue-700 dark:focus:ring-blue-600"
          >
            Playground
          </Link>
          ...
          <button
            onClick={() => setOpen((v) => !v)}
            className="md:hidden p-2 text-gray-500 rounded-lg hover-gray-100 focus:outline-none
            ...
            <ul className="flex flex-col md:flex-row md:space-x-8 mt-4 md:mt-0 font-medium">
                {["signin","signup","dashboard"].map((item)=>(
                    <li key={item}>
                        ...
                        className="block px-3 py-2 rounded hover:text-blue-700 text-gray-900 
