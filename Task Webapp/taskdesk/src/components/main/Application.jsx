...
const Application = ({ onNewTaskClick }) => {
  ...
  return (
    <div className="flex justify-center items-center py-2 bg-transparent mt-2">
      <div className="w-full max-w-md p-1 bg-white dark:bg-gray-900 rounded-3xl shadow-lg border border-gray-200 dark:border-gray-700">
